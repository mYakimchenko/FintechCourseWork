...
sealed class PartialStateChanges {
    ...
    object Refreshing : PartialStateChanges()
    object CurrencyExchangeOpened : PartialStateChanges()
    //    data class FirstTimeListLoaded(val data: List<CurrencyEntity>) : PartialStateChanges()
...
//    object ShowStub : PartialStateChanges()
}