 ...
 * [HistoryFilterFragment.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [HistoryFilterFragment.newInstance] factory method to
...
class HistoryFilterFragment : Fragment() {
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String): HistoryFilterFragment {
            val fragment = HistoryFilterFragment()
            val args = Bundle()
